...
--
-- Host: localhost    Database: appcgid
-- ------------------------------------------------------
...
CREATE TABLE `country` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='pais';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='Catalogo de dispositivos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `genre` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='El sexo de la persona: hombre, mujer';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='Conjunto de presonas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'Conferencia','conferencia@mail.org','General','De la','GEIC580101KN5HO%','GEIC580101KN5','2023-05-26','2023-05-26 21:51:28','0000-00-00 00:00:00',1,1,2,1);
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='Tabla de posiciones del dispositivo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`id`),
  KEY `persona_producto_fk` (`person_id`),
  CONSTRAINT `persona_producto_fk` FOREIGN KEY (`person_id`) REFERENCES `person` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  `description` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='Entidad federativa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `title` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='Catálogo de títulos: se conforma por los tipos de titulos: nombramientos y puesto:\nNombramiento: Ministro, diacono, obrero,\npuesto: Secretario, tesorero, pastor';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='La relación de la persona y sus títulos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `type_person` VALUES
(1,'Fisica'),
(2,'Moral');
...
(1,'grc@gmail.com',1,'2023-05-26 21:16:40',1,0,1,1,'2f4b8cd022e6faa3dad853caad0d43df45673219','2014-10-15 05:00:00',1,'0000-00-00 00:00:00'),
(2,'amd@gmail.com',1,'2023-05-26 21:16:40',1,0,1,1,'37c30dea4522b3be169c27b30acb8d4d73643c39','2014-10-15 05:00:00',1,'0000-00-00 00:00:00'),
(3,'acme@cdx.org',1,'2023-05-26 21:16:40',1,0,1,1,'2f4b8cd022e6faa3dad853caad0d43df45673219','2019-08-01 16:01:22',1,'2019-08-01 16:01:22');
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='relación de usuario y dispositivos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='relacion de usuarios y perfiles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-26 16:10:32
